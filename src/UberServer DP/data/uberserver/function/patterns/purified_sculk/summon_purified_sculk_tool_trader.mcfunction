        ...
        Recipes: [ \
            { \
                ...
                sell: { \
                    ...
                    count: 1, \
                    components: { \
                        item_name: {translate: "uber.pattern.purified_sculk_tool_pattern.name"}, \
                        lore: [{translate: "uber.pattern.patterns.lore"}], \
                        rarity: "rare", \
                        custom_model_data: {strings: ["uber.pattern.purified_sculk_tool_pattern"]}, \
                        custom_data: {type: "uber.pattern", item: "purified_sculk_tool_pattern"} \
                    } \
                } \
            } \
        ] \
