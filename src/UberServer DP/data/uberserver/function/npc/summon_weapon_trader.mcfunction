summon villager ~ ~ ~ { \
    ...
    Tags: ["uber.weapon_trader"], \
    CustomName: {"translate":"uber.npc.pattern_trader_weapon.name", "italic": false}, \
    Offers: { \
        Recipes: [ \
            { \
                maxUses: 999999, \
                ...
                sell: { \
                    ...
                    count: 1, \
                    components: { \
                        item_name: {translate: "uber.pattern.sculk_weapon_pattern.name"}, \
                        lore: [{translate: "uber.pattern.patterns.lore"}], \
                        rarity: "rare", \
                        custom_model_data: {strings: ["uber.pattern.sculk_weapon_pattern"]}, \
                        custom_data: {type: "uber.pattern", item: "sculk_weapon_pattern"} \
                    } \
                } \
            } \
        ] \
